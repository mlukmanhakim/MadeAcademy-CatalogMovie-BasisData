...
public class FavoriteWidget extends AppWidgetProvider {
    ...
    public static final String TOAST_ACTION = "com.dicoding.lukman.catalogmovie.TOAST_ACTION";
    public static final String EXTRA_ITEM = "com.dicoding.lukman.catalogmovie.EXTRA_ITEM";
...
//        views.setTextViewText(R.id.appwidget_text, R.id.empty_view);
