package com.dicoding.lukman.catalogmovie.adapter;
...
import com.dicoding.lukman.catalogmovie.activiy.DetailMovie;
...
private Context context;
    ...
    public void onBindViewHolder(@NonNull MoviewViewHolder holder, final int position) {
        ...
        String gambar = "http://image.tmdb.org/t/p/w185" + currResult.getPosterPath();
